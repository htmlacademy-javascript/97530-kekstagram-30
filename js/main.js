...
const createCom = function (result) {
  return {
      id: generateNumber(),
 ...
 const similarCom = new Array(SIMILAR_COMMENT_COUNT).fill(null).map((element, index) => createCom(index));

const createPhoto = function (result) {
  return {
    id: generateId(),
